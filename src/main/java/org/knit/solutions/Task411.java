...
import org.knit.solutions.lab3.n11.EmailNotifier;
import org.knit.solutions.lab3.n11.MobileApp;
import org.knit.solutions.lab3.n11.Stock;

@TaskDescription(taskNumber = 9, taskDescription = "Задача про Паттерн Observer (Наблюдатель) с дополнениями")
